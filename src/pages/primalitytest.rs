            ...
            tr![
                td![
                    ...
                    form![
                        ...
                        br![],
                        "Is ",
                        input![attrs!{At::Type => "text", At::Size => "16", At::Name => "input", At::Value => "", At::MaxLength => "16"}],
                        " prime? ",
                        button![attrs!{At::OnClick => "check(false,0)"},"Check!"],
                        br![],
                        br![],
                        textarea![attrs!{At::Name => "javascriptoutput", At::Cols => 60, At::Rows => 2, At::Disabled => "disabled"}]
                    ]
                ]
            ]
        ],
            ...
            tr![
                td![
                    ...
                    form![
                        ...
                        br![],
                        "This will show ",
                        input![attrs!{At::Type => "text", At::Size => "4", At::Name => "primes", At::Value => "1", At::MaxLength => "2"}],
                        " prime numbers after ",
                        input![attrs!{At::Type => "text", At::Size => "16", At::Name => "start", At::Value => "0", At::MaxLength => "15"}],
                        " ",
                        button![attrs!{At::OnClick => "primelist.javascriptlistoutput.value='';listy();"},"Go!"],
                        br![],
                        br![],
                        textarea![attrs!{At::Name => "javascriptlistoutput", At::Cols => 60, At::Rows => 10, At::Disabled => "disabled"}]
                    ]
                ]
            ]
        ]
