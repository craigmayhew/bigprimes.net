...
pub fn render() -> seed::dom_types::Node<Msg> {
    div![
        ...
        <tr><td>10th February 2010</td><td>We have added a page that shows the sum of the digits of prime numbers. <a class=\"link\" href=\"/sum-of-digits/\">Click here</a></td></tr>
        ...
        <tr><td>17th July 2008</td><td>We've now added a <a class=\"link\" href=\"/forum/\">Forum</a> which can be found on the navigation links on the left.</td></tr>
