    ...
    div![
        ...
        table![
            ...
            tbody![
                ...
                bp_table_row!("21st February 2024","Rust benchmarks added. Followed by performance and usability improvements."),
                ...
                bp_table_row!("28th July 2019","bigprimes.net has been rewritten from the ground up using Rust!<br>All archives have been retired in favour of client side processing in WebAssembly."),
                ...
                bp_table_row!("12th November 2017","Site is now running on AWS Lambda, but can still fall back to regular VM hosting if ever needed. Site is now ~40% covered by unit tests."),
                ...
                bp_table_row!("28th February 2014","You can now find the website's PHP source code here <a class=\"link\" href=\"https://github.com/craigmayhew/bigprimes.net/\">https://github.com/craigmayhew/bigprimes.net/</a>"),
                ...
                bp_table_row!("1st February 2010","Thanks to everyone for donating computer time, we are now up to 1.4 billion primes. We now also have a Facebook group where you get news updates and show your support for the project!"),
                ...
                bp_table_row!("14th July 2008","Someone named Kirk just emailed me to say the download links weren't working. I've now fixed this. Thanks Kirk!"),
