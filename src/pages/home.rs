...
pub fn render() -> seed::dom_types::Node<Msg> {
    div![
        ...
        <tr><td>10th March 2018</td><td>Added torrents for the <a class=\"link\" href=\"https://static.bigprimes.net/archive/one-million-primes.7z.torrent\">first million primes</a> and <a class=\"link\" href=\"https://static.bigprimes.net/archive/one-billion-primes.7z.torrent\">first billion prime numbers</a>.</td></tr>
