            ...
            tbody![
                tr![
                    ...
                    td![
                        ...
                        a![svg1, attrs!{At::Class => "link", At::Href => "https://static.bigprimes.net/archive/mersenne/Mersenne Primes.zip"}],
                    ],
                ],
                tr![
                    td!["First 12 factored Fermat numbers"],
                    td![
                        a![svg2, attrs!{At::Class => "link", At::Href => "https://static.bigprimes.net/archive/fermat/Fermat Numbers.zip"}],
                    ],
                ],
                tr![
                    ...
                    td![
                        ...
                        a![svg3, attrs!{At::Class => "link", At::Href => "https://static.bigprimes.net/archive/perfect/Perfect Numbers.zip"}],
                    ],
                ]
            ]
        ],
