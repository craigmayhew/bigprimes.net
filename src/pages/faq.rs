...
pub fn render() -> Node<Msg> {
    div![
        ...
        p!["Please open an issue on ",a!["GitHub", attrs!{At::Class => "link", At::Href => "https://github.com/craigmayhew/bigprimes.net/"}]],
        b!["What is the first set of 100 numbers (e.g. 100-199, 1300-1399, 312300-312399) that does not contain a prime number?"],
        p!["The first occurrence is between the prime numbers 1671781 and 1671907 on ",a!["this", attrs!{At::Class => "link", At::Href => "/archive/prime/126100/"}]," page (near bottom of 3rd column)."],
