...
mod tests {
    ...
    fn nth_test() {
        assert_eq!(nth(7), "7th");
        assert_ne!(nth(7), "1st");
        assert_eq!(nth(700000000), "700000000th");
        assert_eq!(nth(700000001), "700000001st");
        assert_eq!(nth(700000002), "700000002nd");
        assert_eq!(nth(700000003), "700000003rd");
        assert_eq!(nth(700000011), "700000011th");
        assert_eq!(nth(700000012), "700000012th");
        assert_eq!(nth(700000013), "700000013th");
    }

    #[bench]
    fn nth_bench(b: &mut Bencher) {
        b.iter(|| nth(700000013));
    }
